...
services:
  dockge:
    image: docker.io/moailaozi/dockge:1.8.0
...
Open <http://localhost:5001>. For production, pin a full version such as `1.8.0`; the `latest` tag follows the
...
For version `1.8.0`, it publishes `1.8.0`, `1.8`, `1`, and `latest` tags.
